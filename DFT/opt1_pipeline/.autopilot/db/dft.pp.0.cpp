...
__attribute__((sdx_kernel("dft", 0))) void dft(DTYPE real_sample[1024], DTYPE imag_sample[1024],DTYPE real_op[1024],DTYPE imag_op[1024])
{
#line 17 "D:/1111HLS/LabC/DFT/DFT/opt1_pipeline/csynth.tcl"
...
# 6 "DFT/dft.cpp"
 ...
 VITIS_LOOP_10_1: for (n = 0; n < 1024; n++)
 {
  VITIS_LOOP_12_2: for (k = 0; k < 1024; k++){
