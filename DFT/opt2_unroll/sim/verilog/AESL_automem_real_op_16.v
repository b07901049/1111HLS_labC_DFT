...
module AESL_automem_real_op_16 (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.dft.autotvin_real_op_16.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.dft.autotvout_real_op_16.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 6;
parameter DEPTH = 32'd 49;
parameter DLY = 0.1;
